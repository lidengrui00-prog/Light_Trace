...
# ==================== 手写最小二乘法优化起始点 ====================
def optimize_start_point(target_xy, direction, surfaces, n_func, bounds=(-50, 50),max_iter=50, tol=1e-8, lambda_init=0.01):
    """
...
if __name__ == "__main__":
    lens_file = f"C:\python_work\光线追迹\Task_trace\副本附件1_镜头参数.csv"
    material_file = f"C:\python_work\光线追迹\Task_trace\材料参数.csv"
    wavelength = 0.5876
