...
class Lensgroup(Endpoint):
    ...
    def sample_ray(self, wavelength, view=0.0, M=15, R=None, shift_x=0., shift_y=0., sampling='grid',
...
class BSpline(Surface):
    ...
    def __init__(self, r, d, size, px=3, py=3, tx=None, ty=None, c=None, is_square=False,
                 device=torch.device('cpu')):  # input c is 1D
        Surface.__init__(self, r, d, is_square, device)
        self.px = px
        self.py = py
